...
function _fromRowAgenda(r) { return { id: r.id, cliente: r.cliente, telefone: r.telefone, servicoIds: r.festa_ids||[], temaId: r.tema_id||null, materiais: r.materiais_usados||{}, sessoes: r.sessoes||[], dataRetirada: r.data_retirada, horaRetirada: r.hora_retirada, sinal: r.sinal, statusCor: r.status_cor, obs: r.obs, sinalAtendId: r.sinal_atend_id||null, concluido: !!r.concluido, atendimentoId: r.atendimento_id||null, separado: !!r.separado, materiaisSeparados: r.materiais_separados||{} }; }
function _toRowAgenda(a) { return { id: a.id, cliente: a.cliente, telefone: a.telefone, festa_ids: a.servicoIds||[], tema_id: a.temaId||null, materiais_usados: a.materiais||{}, sessoes: a.sessoes||[], data_retirada: a.dataRetirada||null, hora_retirada: a.horaRetirada||null, sinal: a.sinal||0, status_cor: a.statusCor||null, obs: a.obs, sinal_atend_id: a.sinalAtendId||null, concluido: !!a.concluido, atendimento_id: a.atendimentoId||null, separado: !!a.separado, materiais_separados: a.materiaisSeparados||{} }; }
